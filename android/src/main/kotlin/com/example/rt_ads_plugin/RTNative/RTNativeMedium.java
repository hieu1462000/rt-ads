 ...
 */
public class RTNativeMedium implements GoogleMobileAdsPlugin.NativeAdFactory {
    private final LayoutInflater layoutInflater;

    public RTNativeMedium(LayoutInflater layoutInflater) {
        this.layoutInflater = layoutInflater;
    }

    @Override
    public NativeAdView createNativeAd(NativeAd nativeAd, Map<String, Object> customOptions) {
        @SuppressLint("InflateParams") final NativeAdView adView = (NativeAdView) layoutInflater.inflate(R.layout.rt_native_medium_view, null);
